...
class _ResetPassword3PageState extends State<ResetPassword3Page> {
  ...
  void _onSubmit() {
    // هنا ممكن تضيف تحقق من تطابق الباسوردات مثلاً
    ...
    // لو صح، ارجع لصفحة تسجيل الدخول
    Navigator.pushReplacementNamed(context, '/login'); // أو الاسم اللي انت معرفه
  }
