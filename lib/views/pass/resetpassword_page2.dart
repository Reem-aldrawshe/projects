...
import 'package:test_app/views/pass/resetpassword_page3.dart';

class ResetPassword2Page extends StatefulWidget {
  final String? email; // لو حابب تمرر الإيميل من الصفحة الأولى
...
class _ResetPassword2PageState extends State<ResetPassword2Page> {
  // 6 TextEditingControllers للرمز
  final List<TextEditingController> _codeControllers = List.generate(
    6,
    (index) => TextEditingController(),
  );

  // List of FocusNodes للتنقل بين الحقول بسهولة
  ...
  // دالة لانتقال أو إلغاء التركيز بناءً على الإدخال
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            // نص "أدخل رمز التحقق الذي تم إرساله"
            Positioned(
              top: 248.h,
              left: 116.w,
              child: SizedBox(
            ...
            // النص "لم يصلك الرمز؟ إرسال مرة أخرى"
            Positioned(
              top: 481.h,
              left: 93.w,
              child: SizedBox(
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        // هنا تقدر تضيف ارسال رمز مرة أخرى
                      },
                      child:Text(
                      'لم يصلك الرمز؟ ',
                      style: TextStyle(
            ...
            Positioned(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    // هنا بعد التحقق رح تروح لصفحة reset password 3
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => ResetPassword3Page(), // رح تبنيها لاحقًا
                      ),
                    );
                  },
                  child: Center(
