...
import 'package:test_app/views/login/register_screen.dart';
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            // النص العلوي "جاهز لنتعلم المزيد؟"
            Positioned(
              top: 100.h,
              left: 112.w,
              child: SizedBox(
